        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4 aurora-bg">
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-black bg-gradient-to-r from-blue-400 to-amber-500 bg-clip-text text-transparent mb-2">
                        {t('auth.signUp')}
                    </h1>
                    <p className="text-slate-500 font-bold text-xs uppercase tracking-widest italic">{t('dashboard.nuclearMode')}</p>
                </div>

                <div className="glass-card p-2 rounded-[2.5rem] bg-gradient-to-b from-amber-500/10 to-transparent border-amber-500/5">
                    <SignUp
                        appearance={{
                            elements: {
                                ...
                                formButtonPrimary: "bg-amber-400 hover:bg-amber-300 text-slate-950 rounded-2xl py-4 font-black text-xs uppercase tracking-widest shadow-xl shadow-amber-400/20",
                ...
                <p className="mt-8 text-center text-slate-700 text-[9px] font-black uppercase tracking-[0.3em]">
                    Instant Access • Anti-Bot Turnstile Verified
                </p>
            </div>
        </div>
    );
